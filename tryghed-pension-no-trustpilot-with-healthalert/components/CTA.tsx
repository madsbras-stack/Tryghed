...
export default function CTA() {
  return (
    <section className="section bg-[color:var(--ink)] text-white rounded-2xl px-8 py-10 md:px-12 md:py-14 mt-12 shadow-lg">
      <div className="grid md:grid-cols-3 gap-8 items-center">
        <div className="md:col-span-2">
          ...
          <ul className="mt-4 grid sm:grid-cols-2 gap-2 text-sm text-white/90">
        ...
        <div className="flex md:justify-end items-start gap-3 md:flex-col">
          <Link href="https://calendly.com/madsbras" className="btn btn-primary w-full md:w-auto text-center">Book gratis samtale</Link>
          <Link href="/kontakt" className="btn btn-secondary w-full md:w-auto text-center">Skriv til os</Link>
        </div>
      </div>
    </section>
  );
